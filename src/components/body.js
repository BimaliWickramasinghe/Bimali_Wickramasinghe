    ...
    return (
      <div>
        ...
        <div class="container2-csm" style={{paddingTop:'40px'}}>
          ...
          <a href={'https://github.com/BimaliWickramasinghe/University_Management_System'}>Visit Reposirory</a>  
            </div>
          </div>
        </div>
        ...
        <SocialIcon url="https://github.com/BimaliWickramasinghe" style={{margin:'10px'}}/>
        <SocialIcon url="https://bimalics.medium.com" style={{margin:'10px'}}/>
        <SocialIcon url="https://linkedin.com/in/bimali-wickramasinghe-3a5984181" style={{margin:'10px'}}/>
</div>
